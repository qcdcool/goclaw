    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="mt-4">
        {showSkeleton ? (
          ...
          <EmptyState
            icon={Wrench}
            title={debouncedSearch ? t("customTools.noMatching") : t("customTools.noCustomTools")}
            description={debouncedSearch ? t("common.tryDifferentSearch") : t("customTools.createFirst")}
          />
        ) : (
